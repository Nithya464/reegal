                    ...
                    if ($(this).is(':checked')) {
                        ...
                        var dataID= $(this).data('id');
                            ...
                            if($("#qty"+dataID).val()==""){
                                ...
                                $("#qty"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else{
                                $("#qty"+dataID).after('');
                            }

                            if($("#cost_price"+dataID).val()==""){
                                $("#cost_price"+dataID).after('<label class="error" >This field is required</label>');
                                checkfields =1;
                            }else if($("#cost_price"+dataID).val()<="0"){
                                $("#cost_price"+dataID).after('<label class="error" >Please enter a value greater than or equal to 1 </label>');
                                checkfields =1;
                            }else{
                                $("#cost_price"+dataID).after('');
                            }

                            if($("#wh_min_price"+dataID).val()=="" ){
                                $("#wh_min_price"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else if($("#wh_min_price"+dataID).val()<="0"){
                                $("#wh_min_price"+dataID).after('<label class="error" >Please enter a value greater than or equal to 1.</label>');
                                checkfields =1;
                            }
                            else{
                                $("#wh_min_price"+dataID).after('');
                            }

                            
                            

                            if($("#min_retail_price"+dataID).val()==""){
                                $("#min_retail_price"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else if($("#min_retail_price"+dataID).val()<="0"){
                                $("#min_retail_price"+dataID).after('<label class="error" >Please enter a value greater than or equal to 1.</label>');
                                checkfields =1;
                            }
                            else{
                                $("#min_retail_price"+dataID).after('');
                            }

                            if($("#base_price"+dataID).val()==""){
                                $("#base_price"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else if($("#base_price"+dataID).val()<="0"){
                                $("#base_price"+dataID).after('<label class="error" >Please enter a value greater than or equal to 1.</label>');
                                checkfields =1;
                            }
                            else{
                                $("#base_price"+dataID).after('');
                            }

                            if($("#rack"+dataID).val()==""){
                                $("#rack"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else{
                                $("#rack"+dataID).after('');
                            }
                            ...
                            if($("#section"+dataID).val()==""){
                                $("#section"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else{
                                $("#section"+dataID).after('');
                            }

                            if($("#row"+dataID).val()==""){
                                $("#row"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else{
                                $("#row"+dataID).after('');
                            }

                            if($("#box_no"+dataID).val()==""){
                                $("#box_no"+dataID).after('<label class="error" >This field is required.</label>');
                                checkfields =1;
                            }else{
                                $("#box_no"+dataID).after('');
                            }
                           
                            if (!$("#qty1").prop("readonly") && $("#qty1").val() == $("#qty2").val()) {
                                if (!errorDisplayed) {
                                errorDisplayed = true;
                                $("#qty2").after('<label class="error">Qty Can Not Be Same.</label>');
                                }
                                checkfields = 1;
                              } else if (!$("#qty1").prop("readonly") && $("#qty1").val() == $("#qty3").val()) {
                                if (!errorDisplayed) {
                                errorDisplayed = true;
                                $("#qty3").after('<label class="error">Qty Can Not Be Same.</label>');
                                }
                                checkfields = 1;
                              } else if (!$("#qty2").prop("readonly") && $("#qty2").val() == $("#qty3").val()) {
                                if (!errorDisplayed) {
                                errorDisplayed = true;
                                $("#qty2").after('<label class="error">Qty Can Not Be Same.</label>');
                                }
                                ...
                                $("#qty1").next('.error').remove(); // Remove any existing error label
                                $("#qty2").next('.error').remove(); // Remove any existing error label
                                $("#qty3").next('.error').remove(); // Remove any existing error label
                              }
