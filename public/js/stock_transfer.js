$(document).ready(function() {
    ...
    //             var dropdown = $('#search_product_for_stock_adjustment');
    //             dropdown.empty();
    //             // console.log(res.product_id);
    //             $.each(JSON.parse(res), function(index, element) {
    //                 var option = $('<option></option>')
    //                 .val(element.product_id)
    //                 .text(element.name);
    ...
    $('#search_product_for_srock_adjustment').on('click', function () {
        $(this).autocomplete({
          source: function (request, response) {
    ...
    $(document).on('keyup', 'input.product_quantity', function() {
        console.log('ST');
        update_table_row($(this).closest('tr'));
    });
    $(document).on('keyup', 'input.product_unit_price', function() {
        console.log('ST');
        update_table_row($(this).closest('tr'));
    });
