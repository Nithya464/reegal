...
use App\Http\Controllers\PurchaseOrderByVendorController;
use App\Http\Controllers\PurchaseOrderByVendorImController;
use App\Http\Controllers\PurchaseOrderController;
use App\Http\Controllers\PurchaseOrderRController;
...
use App\Http\Controllers\WriteChequeController;
use App\Http\Controllers\ReceivePaymentController;
use App\Http\Controllers\SpSellController;
...
Route::middleware(['setData'])->group(function () {
    ...
    Route::post('/business/registers/check-email', [BusinessController::class, 'postCheckEmail'])->name('business.postCheckEmail');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    // Manage Tax module route
    Route::resource('taxes', TaxController::class);
    
    // Manage Driver module route
    Route::resource('drivers', DriverController::class);

    // Mange Driver Log Module for sales manager role
    Route::prefix('driver/log')
        ->controller(DriverLogController::class)
        ->group(function () {
            Route::get('/', 'index')->name('driver-log');
        });
    ...
    Route::get('/get-cities/{stateId}', [ZipcodeController::class, 'getCities'])->name('get-cities');
    Route::resource('customers_locations', CustomerLocationController::class);
    Route::resource('customer_orders',CustomerOrderController::class);
    Route::resource('manage_expenses',ManageExpenseController::class);
    // End Sanjay Dhapa   
    ...
    // Gopal
        Route::resource('cheques', WriteChequeController::class);
    // End Gopal
    ...
    Route::resource('assigned-driver', AssignedDriverController::class);
    ...
    Route::resource('pos-sells', 'PosSellController')->except(['show']);
    Route::resource('sp-sells', 'SpSellController')->except(['show']);
    Route::get('/pos-sells/get_product_row/{variation_id}/{location_id}', [PosSellController::class, 'getProductRow']);
    ...
    Route::resource('pos-sells', PosSellController::class);
    Route::resource('sp-sells', SpSellController::class);
    // Route::put('pos-sells/update', [PosSellController::class, 'update']);//->except(['show']);
    ...
    Route::group(['prefix' => 'stock', 'as' => 'stock.'], function () {
        ...
        Route::post('get_unit', [ProductStockController::class, 'getUnit'])->name('get_unit');
        Route::get('update-log', [ProductStockController::class, 'getUpdateStockLog'])->name('update-log');
    });
    ...
    // Sagar desai
    Route::resource('receive_payment', ReceivePaymentController::class)->only('index','create','delete','edit');
    Route::get('/payment-details', [ReceivePaymentController::class, 'getItem'])->name('payment.details');
    Route::post('receive-Payment/create', [ReceivePaymentController::class, 'create'])->name('receivePayment_create');;
    Route::post('receive-Payment/save', [ReceivePaymentController::class, 'save'])->name('receivePayment_update');;
    Route::get('receive-payment/delete/{id}', [ReceivePaymentController::class, 'delete'])->name('receive_payment_delete');;
    Route::get('receive-payment/edit/{id}', [ReceivePaymentController::class, 'edit'])->name('receive_payment_edit');;
    ...
    Route::resource('purchase-order-vendor', PurchaseOrderByVendorController::class);
    Route::resource('purchase-order-vendor-im', PurchaseOrderByVendorImController::class);
    Route::resource('purchase-order-r', PurchaseOrderRController::class);
    Route::resource('receive-stock', ReceiveStockController::class);
});
