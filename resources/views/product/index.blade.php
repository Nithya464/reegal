        ...
        $(document).ready(function() {
            product_table = $('#product_table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'commission_per',
                        name: 'products.commission_per'
                    },
                    // {
                    //     data: 'ml_qty',
                    //     name: 'products.ml_qty'
                    // },
                    // {
                    //     data: 'weight',
            ...
            var columnsToHide = [
                    'product_custom_field2:name',
                    'product_custom_field3:name',
                    'product_custom_field4:name'
                ];
            for (var i = 0; i < columnsToHide.length; i++) {
                product_table.column(columnsToHide[i]).visible(false);
            }
