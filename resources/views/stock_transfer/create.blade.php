				...
				<div class="col-sm-8 col-sm-offset-2">
					<div class="form-group">
						<div class="input-group">
							...
							{{-- {!! Form::select('product',[], null, ['class' => 'form-control', 'id' => 'search_product_for_stock_adjustment', 'placeholder' => __('stock_adjustment.search_product')]) !!} --}}
						</div>
					</div>
				</div>
			</div>
