@extends('layouts.app')
@section('title', __('Credit Memo List'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang('Credit Memo List')
    </h1>
</section>
...
<section class="content no-print">
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('sell_list_filter_sales_person_id',  __('Sales Person') . ':') !!}
                {!! Form::select('sell_list_filter_sales_person_id', $customers, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('status', $customers, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
        ...
        @endcan
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => __('Credit Memo List'), 'is_memo' => true, 'orders' => $orders])
...
<script>
    ...
    jQuery('body').on('change','#sell_order_id',function(){
        let id = $(this).val();
        window.location.href = "{{ url('sell-return/add') }}/"+id;
    });
</script>
