<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action([\App\Http\Controllers\TaxController::class, 'store']), 'method' => 'post', 'id' => 'tax_add_form' ]) !!}
    ...
    <div class="modal-body">
      <div class="form-group">
        {!! Form::label('name', __( 'tax.tax_name' ) . ':*') !!}
          {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax.tax_name' ) ]); !!}
      </div>
      ...
      <div class="form-group">
        {!! Form::label('tax', __( 'tax.tax' ) . '%:*') !!}
          {!! Form::text('tax', null, ['class' => 'form-control input_number', 'required']); !!}
      </div>

      <div class="form-group">
        {!! Form::label('print_label_text', __( 'tax.print_label_text' ) . ':*') !!}
          {!! Form::text('label_text', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax.print_label_text' ) ]); !!}
      </div>
