...
<section class="content">
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\PurchaseOrderByVendorController::class, 'store']), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					{!! Form::text('status', 'Draft', ['class' => 'form-control', 'readonly']); !!}
				</div>
			</div>
		</div>
	@endcomponent
