		...
		<div class="row">
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('ref_no', __('purchase.po_no').':') !!}
					{!! Form::text('ref_no', null, ['class' => 'form-control', 'readonly']); !!}
				</div>
			</div>
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('transaction_date', __('purchase.po_date') . ':*') !!}
			...
			{{-- <div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('location_id', __('From').':*') !!}
					@show_tooltip(__('tooltip.purchase_location'))
					{!! Form::select('location_id', $fromLocations,null, ['class' => 'form-control select2', 'required'], $bl_attributes); !!}
				</div>
			</div> --}}
			...
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('to_location_id', __('To').':*') !!}
					@show_tooltip(__('tooltip.purchase_location'))
					{!! Form::select('to_location_id', $business_locations, $default_location, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required'], $bl_attributes); !!}
				</div>
			</div>
			{{-- <div class="col-sm-4">
				<div class="form-group">
					{!! Form::label('barcode', __('purchase.barcode').':') !!}
