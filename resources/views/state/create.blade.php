<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@lang( 'Add State' )</h4>
    </div>
      ...
      <div class="row">
        <div class="form-group col-sm-12">
          {!! Form::label('state_name', __( 'State Name' ) . ':*') !!}
            {!! Form::text('state_name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'Enter State Name' )]); !!}
        </div>

        <div class="form-group col-sm-12">
          {!! Form::label('abbreviation', __( 'Abbreviation' ) . ':*') !!}
            {!! Form::text('abbreviation', null, ['class' => 'form-control', 'placeholder' => __( 'Enter Abbreviation' ), 'required']); !!}
        </div>
