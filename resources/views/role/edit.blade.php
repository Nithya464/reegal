...
@section('content')
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock.create', in_array('stock.create', $role_permissions), [
                                        'class' => 'input-icheck',
            ...
            <div class="row check_group">
                <div class="col-md-1">
                    <h4>{{ __('Purchase Order Internal') }}</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label>
                ...
                <div class="col-md-9">
                    ...
                    {{-- <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio(
                                    'radio_option[purchase_order_R_view]',
                                    'purchase_order_R.view_all',
                                    in_array('purchase_order_R.view_all', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('View all R - PO List') }}
                            </label>
                        </div>
                    </div> --}}
                    {{-- <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'purchase_order.print_invoice', in_array('print_invoice', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'purchase_order.download_invoice_pdf', in_array('download_invoice_pdf', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                <div class="col-md-1">
                    <h4>{{ __('Purchase Order By Vendor') }}</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label>
                ...
                <div class="col-md-9">
                    {{-- <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio(
                                    'radio_option[receive_stock_view]',
                                    'receive_stock.view_all',
                                    in_array('receive_stock.view_all', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('View all PO List (IM)') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio(
                                    'radio_option[receive_stock_view]',
                                    'receive_stock.view_own',
                                    in_array('receive_stock.view_own', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __(' View own PO List (IM)') }}
                            </label>
                        </div>
                    </div> --}}
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'purchase_order_IM.draft_view_all',
                                    in_array('purchase_order_IM.draft_view_all', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('Draft PO List (IM)') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'purchase_order_IM.update',
                                    in_array('purchase_order_IM.update', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('Update Draft PO List (IM)') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('purchase_order_IR.view_all', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('View all PO List (IR)') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('purchase_order_IR.create', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('Generate PO (IR)') }}
                            </label>
                        </div>
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('purchase_order_IR.update', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('Update PO (IR)') }}
                            </label>
                        </div>
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('purchase_order_IR.delete', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('Delete PO (IR)') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'receive_stock.create',
                                    in_array('receive_stock.create', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('Add Receive Stock') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('receive_stock.update', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('Edit Receive Stock') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('permissions[]', 'draft_customer.view', in_array('draft_customer.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __(' View Draft-Customer') }}
                          </label>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('permissions[]', 'draft_customer.create', in_array('draft_customer.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __(' Add Draft-Customer') }}
                          </label>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('permissions[]', 'draft_customer.update', in_array('draft_customer.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __(' Edit Draft-Customer') }}
                          </label>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('permissions[]', 'draft_customer.delete', in_array('draft_customer.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __(' Delete Draft-Customer') }}
                          </label>
                        </div>
                        <hr>
                      </div>
                      <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('permissions[]', 'customer_location.view',in_array('customer_location.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __(' View Customer Location') }}
                          </label>
                        </div>
                      </div>
                </div>
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[purchase_view]', 'stock.view', in_array('stock.view', $role_permissions), [
                                        'class' => 'input-icheck',
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock.update', in_array('stock.update', $role_permissions), [
                                        'class' => 'input-icheck',
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock.delete', in_array('stock.delete', $role_permissions), [
                                        'class' => 'input-icheck',
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'order.view', in_array('order.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View Order') }}
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'car.view', in_array('car.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('View Car') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'car.create', in_array('car.create', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Add Car') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'car.update', in_array('car.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Edit Car') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'car.delete', in_array('car.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Delete Car') }}
                            </label>
                        </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'route.view', in_array('route.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('View Route') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'route.create', in_array('route.create', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Add Route') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'route.update', in_array('route.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Edit Route') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'route.delete', in_array('route.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Delete Route') }}
                            </label>
                        </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'price_level.view', in_array('price_level.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('View Price Level') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'price_level.create', in_array('price_level.create', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Add Price Level') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'price_level.update', in_array('price_level.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Edit Price Level') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'price_level.delete', in_array('price_level.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Delete Price Level') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'purchase_return.update', in_array('purchase_return.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Edit Credit Memo') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'purchase_return.delete', in_array('purchase_return.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Delete Credit Memo') }}
                            </label>
                        </div>
                    </div> --}}
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'state.view',  in_array('state.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View State') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'state.create', in_array('state.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Add State') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'state.update', in_array('state.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Edit State') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'state.delete', in_array('state.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Delete State') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'city.view', in_array('city.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View City') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'city.create', in_array('city.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Add City') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'city.update', in_array('city.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Edit City') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'city.delete', in_array('city.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Delete City') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('permissions[]', 'zipcode.view', in_array('zipcode.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View Zipcode') }}
                          </label>
                      </div>
                  </div>
                  <div class="col-md-12">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('permissions[]', 'zipcode.create', in_array('zipcode.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Add Zipcode') }}
                          </label>
                      </div>
                  </div>
                  <div class="col-md-12">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('permissions[]', 'zipcode.update', in_array('zipcode.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Edit Zipcode') }}
                          </label>
                      </div>
                  </div>
                  <div class="col-md-12">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('permissions[]', 'zipcode.delete', in_array('zipcode.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Delete Zipcode') }}
                          </label>
                      </div>
                  </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'manage_expense.view', in_array('manage_expense.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View Expense') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'manage_expense.create', in_array('manage_expense.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Add Expense') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'manage_expense.update', in_array('manage_expense.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Edit Expense') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'manage_expense.delete', in_array('manage_expense.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Delete Expense') }}
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'tax.view', in_array('tax.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View Tax') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'tax.create', in_array('tax.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Add Tax') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'tax.update', in_array('tax.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Edit Tax') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'tax.delete', in_array('tax.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Delete Tax') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'driver.view', in_array('driver.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View Driver') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'driver.create', in_array('driver.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Add Driver') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'driver.update', in_array('driver.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Edit Driver') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'driver.delete', in_array('driver.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Delete Driver') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-9">
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_pos.view', in_array('direct_sell_pos.view', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_pos.create', in_array('direct_sell_pos.create', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_pos.update', in_array('direct_sell_pos.update', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_pos.delete', in_array('direct_sell_pos.delete', $role_permissions), 
            ...
            <div class="col-md-9">
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_sp.view', in_array('direct_sell_sp.view', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_sp.create', in_array('direct_sell_sp.create', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_sp.update', in_array('direct_sell_sp.update', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'direct_sell_sp.delete', in_array('direct_sell_sp.delete', $role_permissions), 
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vendor.view', in_array('vendor.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Vendor View') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vendor.create', in_array('vendor.create', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Vendor Create') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vendor.update', in_array('vendor.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Vendor Update') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vendor.delete', in_array('vendor.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Vendor Delete') }}
                            </label>
                        </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-2">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" class="check_all input-icheck"> {{ __('select_all') }}
                        </label>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'write_cheque.view', in_array('write_cheque.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('View Write Cheque') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'write_cheque.create', in_array('write_cheque.create', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Add Write Cheque') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'write_cheque.update', in_array('write_cheque.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Edit Write Cheque') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'write_cheque.delete', in_array('write_cheque.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Delete Write Cheque') }}
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('receive_payment.view', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('role.receive_payment.view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('receive_payment.create', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('role.receive_payment.create') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'receive_payment.update',
                                    in_array('receive_payment.update', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('role.receive_payment.update') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('receive_payment.delete', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!} {{ __('role.receive_payment.delete') }}
                            </label>
                        </div>
                    </div>
                </div>
