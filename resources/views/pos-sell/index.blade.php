...
<section class="content no-print">
    @component('components.filters', ['title' => __('report.filters')])
        ...
        @endif --}}
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'Order List')])
        @can('direct_sell_pos.create')
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-block btn-primary" href="{{action([\App\Http\Controllers\PosSellController::class, 'create'])}}">
