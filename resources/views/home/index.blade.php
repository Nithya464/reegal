                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          ...
                          <span class="info-box-number total_customer">0<i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                         ...
                         <div class="info-box-content">
                           ...
                           <span class="info-box-number total_products">0<i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                         ...
                         <div class="info-box-content">
                           <span class="info-box-text">{{ __('Categoryies') }}</span>
                           <span class="info-box-number total_category">0<i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                         ...
                         <div class="info-box-content">
                           ...
                           <span class="info-box-number total_brands">0<i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                         </div>
                     </div>
                 </div>
                {{-- <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
