			...
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						{!! Form::text('delivery_date', $transaction->transaction_date, ['class' => 'form-control','readonly']); !!}
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						{!! Form::text('customer_type', config('global.customer_type')[$transaction->contact->customer_type], ['class' => 'form-control', 'readonly', 'required']); !!}
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						{!! Form::label('terms', __('Terms') . ':') !!}
						{!! Form::text('terms', config('global.customer_terms')[$transaction->contact->term], ['class' => 'form-control', 'readonly', 'required']); !!}
					</div>
				</div>
				<div class="col-md-3">
                    <div class="form-group">
