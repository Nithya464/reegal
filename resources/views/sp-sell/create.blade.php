...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	{!! Form::open(['url' => action([\App\Http\Controllers\SpSellController::class, 'store']), 'method' => 'post', 'id' => 'add_sell_form', 'files' => true ]) !!}
	 @if(!empty($sale_type))
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="col-md-3">
					<div class="form-group">
						{!! Form::label('delivery_date', __('Delivery Date') . ':') !!}
						<div class="input-group">
							<span class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</span>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						{!! Form::text('status', 'New', ['class' => 'form-control', 'readonly', 'required']); !!}
					</div>
				</div>
                ...
                <div class="col-md-3">
					<div class="form-group">
						...
						{!! Form::text('customer_type', null, ['class' => 'form-control', 'readonly', 'required']); !!}
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						{!! Form::label('terms', __('Terms') . ':') !!}
						{!! Form::text('terms', null, ['class' => 'form-control', 'readonly', 'required']); !!}
					</div>
				</div>
				<div class="col-md-3">
                    <div class="form-group">
...
@section('javascript')
	<script src="{{ asset('js/ps-sell.js?v=' . $asset_v) }}"></script>
