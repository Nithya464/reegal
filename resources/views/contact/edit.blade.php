    ...
    <div class="modal-content">
        ...
        @if ($contact->type == 'supplier')
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        {!! Form::text('type',$contact->type, [
                                'class' => 'form-control',
                                'placeholder' => __('lang_v1.type'),
                                'rows' => 3,
                                'readonly'
                            ]) !!}
                    ...
                    {{-- <div class="col-md-6">
                        <div class="form-group MyLable">
                            {!! Form::label('is_draft', __('lang_v1.is_draft') . ':') !!}
                            {!! Form::checkbox('is_draft', 1, $contact->is_draft == 1 ? true : false, [
                                'class' => 'input-icheck',
                                'id' => 'is_draft',
                            ]) !!}
                        </div>
                    ...
                    <div id="more_div" class="hide">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                {!! Form::label('lat', __('business.lat') . ':') !!}
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-globe"></i>
                                    </span>
                                    {!! Form::text('lat', $contact->lat, [
                                        'class' => 'form-control',
                                        'placeholder' => __('business.lat_palaceholder'),
                                    ]) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                {!! Form::label('long', __('business.long') . ':') !!}
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-globe"></i>
                                    </span>
                                    {!! Form::text('long', $contact->long, [
                                        'class' => 'form-control',
                                        'placeholder' => __('business.long_palaceholder'),
                                    ]) !!}
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('name', $contact->name, ['class' => 'form-control', 'required', 'placeholder' => __('lang_v1.name')]) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('customer_type', config('global.customer_type'), $contact->customer_type, [
                                'class' => 'form-control',
                                'id' => 'contact_type',
                                'placeholder' => __('messages.please_select'),
                                'required',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('status', config('global.status_dropdown'), $contact->status, [
                                'class' => 'form-control',
                                'id' => 'status',
                                'required',
                            ]) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('price_level_id', __('Price Level') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-check"></i>
                            </span>
                            {!! Form::select('price_level_id', $priceLevels, $contact->price_level_id, [
                                'class' => 'form-control',
                                'id' => 'price_level_id',
                                'placeholder' => __('messages.please_select'),
                                'required',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('sales_person_id', __('Sales Persons') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user"></i>
                            </span>
                            {!! Form::select('sales_person_id', $salesPersons, $contact->sales_person_id, [
                                'class' => 'form-control',
                                'id' => 'sales_person_id',
                                'placeholder' => __('messages.please_select'),
                                'required',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('tax_id', __('Tax ID') . ':') !!}
                        {!! Form::text('tax_id', $contact->tax_id, ['class' => 'form-control', 'placeholder' => __('Enter Tax ID')]) !!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('term', __('Terms') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-check"></i>
                            </span>
                            {!! Form::select('term', config('global.customer_terms'), $contact->term, [
                                'class' => 'form-control',
                                'id' => 'term',
                                'placeholder' => __('messages.please_select'),
                                'required',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('bussiness_name', __('Bussiness Name') . ':') !!}
                        {!! Form::text('bussiness_name', $contact->bussiness_name, ['class' => 'form-control', 'placeholder' => __('Bussiness Name')]) !!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('otp_licence', __('OTP Licence') . ':') !!}
                        {!! Form::text('otp_licence', $contact->otp_licence, ['class' => 'form-control', 'placeholder' => __('OTP Licence')]) !!}
                    </div>
                </div>

                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('store_open_time', __('Store Open Time') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-check"></i>
                            </span>
                            {!! Form::select('store_open_time', config('global.customer_times'), $contact->store_open_time, [
                                'class' => 'form-control',
                                'id' => 'store_open_time',
                            ]) !!}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('store_close_time', __('Store Close Time') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-check"></i>
                            </span>
                            {!! Form::select('store_close_time', config('global.customer_times'), $contact->store_close_time, [
                                'class' => 'form-control',
                                'id' => 'store_close_time',
                            ]) !!}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('customer_discount', __('Customer Discount') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-check"></i>
                            </span>
                            {!! Form::select('customer_discount', config('global.customer_per'), $contact->customer_discount, [
                                'class' => 'form-control',
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('remark', $contact->remark, ['class' => 'form-control', 'placeholder' => __('Remark')]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('state', $contact->state, ['class' => 'form-control', 'placeholder' => __('business.state'), 'readonly']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('city', $contact->city, ['class' => 'form-control', 'placeholder' => __('business.city'), 'readonly']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group MyLable">
                        {!! Form::checkbox('same_as_billing', 1, $contact->same_as_billing, ['class' => 'input-icheck', 'id' => 'same_as_billing']) !!}
                        {!! Form::label('same_as_billing', __('Shipping Address Same as Billing Address') . ':') !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('shipping_address_1', __('lang_v1.address_line_1') . ':*') !!}
                        {!! Form::text('shipping_address_1', $contact->shipping_address_1, [
                            'class' => 'form-control',
                            'placeholder' => __('lang_v1.address_line_1'),
                            'rows' => 3,
                            'required',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('shipping_address_2', __('lang_v1.address_line_2') . ':') !!}
                        {!! Form::text('shipping_address_2', $contact->shipping_address_2, [
                            'class' => 'form-control',
                            'placeholder' => __('lang_v1.address_line_2'),
                            'rows' => 3,
                        ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('shipping_zipcode', __('business.zip_code') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-map-marker"></i>
                            </span>
                            {!! Form::text('shipping_zipcode', $contact->shipping_zipcode, [
                                'class' => 'form-control',
                                'placeholder' => __('business.zip_code_placeholder'),
                                'readonly',
                            ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('shipping_state', __('business.state') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-map-marker"></i>
                            </span>
                            {!! Form::text('shipping_state', $contact->shipping_state, [
                                'class' => 'form-control',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('shipping_city', __('business.city') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-map-marker"></i>
                            </span>
                            {!! Form::text('shipping_city', $contact->shipping_city, [
                                'class' => 'form-control',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('shipping_lat', __('business.lat') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-globe"></i>
                            </span>
                            {!! Form::text('shipping_lat', $contact->shipping_lat, [
                                'class' => 'form-control',
                                'placeholder' => __('business.lat_palaceholder'),
                                'readonly',
                            ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('shipping_long', __('business.long') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-globe"></i>
                            </span>
                            {!! Form::text('shipping_long', $contact->shipping_long, [
                                'class' => 'form-control',
                                'placeholder' => __('business.long_palaceholder'),
                                'readonly',
                            ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('contact_type', config('global.customer_contact_type'), $contact->contact_type, [
                                'class' => 'form-control',
                                'id' => 'contact_type',
                                'placeholder' => __('messages.please_select'),
                                'required',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('contact_person', $contact->contact_person, [
                            'class' => 'form-control',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('contact_email', __('Email') . ':*') !!}
                        {!! Form::text('contact_email', $contact->contact_email, [
                            'class' => 'form-control',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('contact_landline_1', __('Contact Landline 1') . ':*') !!}
                        {!! Form::text('contact_landline_1', $contact->contact_landline_1, [
                            'class' => 'form-control',
                            'placeholder' => __('Contact Landline1'),
                            'rows' => 3,
                            'required',
                        ]) !!}
                    </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('contact_landline_2', __('Contact Landline 2') . ':') !!}
                        {!! Form::text('contact_landline_2', $contact->contact_landline_2, [
                            'class' => 'form-control',
                            'placeholder' => __('Contact Landline 2'),
                            'rows' => 3,
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('contact_mobile', __('Contact Mobile') . ':*') !!}
                        {!! Form::text('contact_mobile', $contact->contact_mobile, [
                            'class' => 'form-control',
                            'placeholder' => __('Contact Mobile'),
                            'rows' => 3,
                            'required',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('contact_fax_no', __('Contact Fax No') . ':') !!}
                        {!! Form::text('contact_fax_no', $contact->contact_fax_no, [
                            'class' => 'form-control',
                            'placeholder' => __('Contact Fax No'),
                            'rows' => 3,
                        ]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group MyLable">
                        {!! Form::label('contact_is_default', __('Is Default') . ':') !!}
                        {!! Form::checkbox('contact_is_default', 1, $contact->contact_is_default==1 ? true : false, ['class' => 'input-icheck', 'id' => 'contact_is_default']) !!}
                    </div>
                </div>

                {{-- <div class="col-md-12">
                    <div class="form-group MyLable">
                        {!! Form::label('is_draft', __('Customer Save As Draft') . ':') !!}
                        {!! Form::checkbox('is_draft', 1, $contact->is_draft == 1 ? true : false, ['class' => 'input-icheck', 'id' => 'is_draft']) !!}
                    </div>
                </div> --}}
...
<script>
     $(document).ready(function() {
        ...
        $('body').on('click', '#same_as_billing', function() {
            if ($(this).prop("checked")) {
                var address1=$('#address_line_1').val();
                var address2=$('#address_line_2').val();
                $('#shipping_address_1').val(address1).prop('readonly', true);
                $('#shipping_address_2').val(address2).prop('readonly', true);
                $('#shipping_zipcode').val($('#zip_code').val());
                $('#shipping_state').val($('#state').val());
                $('#shipping_city').val($('#city').val());
                $('#shipping_lat').val($('#lat').val());
                $('#shipping_long').val($('#long').val());
            } else {
                $('#shipping_address_1').val(null).prop('readonly', false);
                $('#shipping_address_2').val($(null).val()).prop('readonly', false);
                $('#shipping_zipcode').val(null);
                $('#shipping_state').val(null);
                $('#shipping_city').val(null);
                $('#shipping_lat').val(null);
                $('#shipping_long').val(null);
            }
        });
     });
