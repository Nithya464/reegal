...
<section class="content">
    ...
    @if($type == 'customer' || $type == 'draft_customer')
        <div class="col-md-3">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'contact.all_your_contact', ['contacts' => __('lang_v1.'.$type.'s') ])])
        @if(auth()->user()->can('supplier.create') || auth()->user()->can('customer.create') || auth()->user()->can('supplier.view_own') || auth()->user()->can('customer.view_own') || auth()->user()->can('draft_customer.create'))
            @slot('tool')
                <div class="box-tools">
                ...
                <thead>
                    <tr>
                        ...
                        @elseif( $type == 'customer')
                            ...
                            @endif --}}
                            {{-- <th>lang_v1.customer_group</th>
                            <th>business.address</th>
                           
                            <th>contact.total_sale_due</th> --}}
                ...
                <tfoot>
                    ...
                    <tr class="bg-gray font-17 text-center footer-total">
                        ...
                        <td
                            @if($type == 'supplier')
                                colspan="6"
                            @elseif( $type == 'customer' || $type == 'draft_customer')
                                {{-- @if($reward_enabled)
                                    colspan="9"
                                @else
                                    colspan="8"
