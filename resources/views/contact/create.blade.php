<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-md-4 contact_type_div">
                        ...
                        <div class="form-group">
                            {{-- {!! Form::label('type', __('lang_v1.contact_type') . ':') !!} --}}
                            {!! Form::text('type','supplier', [
                                'class' => 'form-control',
                    ...
                    {{-- <div class="col-md-6">
                        <div class="form-group MyLable">
                            ...
                            {!! Form::checkbox('is_draft', 1, false, ['class' => 'input-icheck', 'id' => 'is_draft']) !!}
                        </div>
                    </div> --}}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('lat', null, ['class' => 'form-control', 'placeholder' => __('business.lat_palaceholder')]) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('long', null, ['class' => 'form-control', 'placeholder' => __('business.long_palaceholder')]) !!}
                                </div>
                            </div>
                        </div>
        ...
        @endif
        @if (request()->query('type') == 'customer' || request()->query('type') == 'draft_customer')
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('customer_type', config('global.customer_type'), null, [
                                    'class' => 'form-control',
                                    'id' => 'contact_type',
                                    'placeholder' => __('messages.please_select'),
                                    'required',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('price_level_id', $priceLevels, null, [
                                    'class' => 'form-control',
                                    'id' => 'price_level_id',
                                    'placeholder' => __('messages.please_select'),
                                    'required',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('sales_person_id', $salesPersons, null, [
                                    'class' => 'form-control',
                                    'id' => 'sales_person_id',
                                    'placeholder' => __('messages.please_select'),
                                    'required',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('tax_id', null, ['class' => 'form-control', 'placeholder' => __('Enter Tax ID')]) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('term', config('global.customer_terms'), null, [
                                    'class' => 'form-control',
                                    'id' => 'term',
                                    'placeholder' => __('messages.please_select'),
                                    'required',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('bussiness_name', null, ['class' => 'form-control', 'placeholder' => __('Bussiness Name')]) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('otp_licence', __('OTP Licence') . ':') !!}
                            {!! Form::text('otp_licence', null, ['class' => 'form-control', 'placeholder' => __('OTP Licence')]) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('store_open_time', config('global.customer_times'), '06:00 AM', [
                                    'class' => 'form-control',
                                    'id' => 'store_open_time',
                                ]) !!}
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('store_close_time', config('global.customer_times'), '10:00 PM', [
                                    'class' => 'form-control',
                                    'id' => 'store_close_time',
                                ]) !!}
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('customer_discount', config('global.customer_per'), null, [
                                    'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('state', null, ['class' => 'form-control', 'placeholder' => __('business.state'), 'readonly']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('city', null, ['class' => 'form-control', 'placeholder' => __('business.city'), 'readonly']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group MyLable">
                            {!! Form::checkbox('same_as_billing', 1, false, ['class' => 'input-icheck', 'id' => 'same_as_billing']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_address_1', null, [
                                'class' => 'form-control',
                                'placeholder' => __('lang_v1.address_line_1'),
                                'rows' => 3,
                                'required',
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_address_2', null, [
                                'class' => 'form-control',
                                'placeholder' => __('lang_v1.address_line_2'),
                                'rows' => 3,
                            ]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('shipping_zipcode', null, [
                                    'class' => 'form-control',
                                    'placeholder' => __('business.zip_code_placeholder'),
                                    'readonly',
                                ]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('contact_type', config('global.customer_contact_type'), null, [
                                    'class' => 'form-control',
                                    'id' => 'contact_type',
                                    'placeholder' => __('messages.please_select'),
                                    'required',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('contact_landline_1', null, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('contact_landline_2', null, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group MyLable">
                            ...
                            {!! Form::checkbox('contact_is_default', 1, false, ['class' => 'input-icheck', 'id' => 'contact_is_default']) !!}
                        </div>
                    </div>
                    
                    @if (request()->query('type') == 'customer')
                        {!! Form::hidden('is_draft',2, ['class' => 'form-control','rows' => 3]) !!}
                    @elseif(request()->query('type') == 'draft_customer')
                        {!! Form::hidden('is_draft',1, ['class' => 'form-control','rows' => 3]) !!}
                    @else
                        {!! Form::hidden('is_draft',2, ['class' => 'form-control','rows' => 3]) !!}
                    @endif
