...
class PurchaseOrderController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('purchase_order.create')
            ->with(compact('taxes', 'business_locations', 'currency_details', 'customer_groups', 'types', 'shortcuts', 'bl_attributes', 'shipping_statuses', 'users', 'common_settings','fromLocations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction_data = $request->only(['ref_no', 'contact_id', 'transaction_date','additional_notes','total_before_tax']);
            ...
            $transaction_data['location_id'] = 1;
            ...
            $transaction_data['delivery_date'] = $transaction_data['transaction_date'];//$this->productUtil->uf_date($transaction_data['transaction_date'], true);
