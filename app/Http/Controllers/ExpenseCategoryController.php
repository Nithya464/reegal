            ...
            return Datatables::of($expense_category)
                ->addColumn('action', function ($row) {
                    ...
                    if (auth()->user()->can("expense_category.update")) {
                       ...
                       $actionHtml .= '<button data-href="'.action('App\Http\Controllers\ExpenseCategoryController@edit', [$row->id]).'" class="btn btn-xs btn-primary btn-modal" data-container=".expense_category_modal"><i class="glyphicon glyphicon-edit"></i></button> &nbsp;';
                    }
                    if (auth()->user()->can("expense_category.delete")) {
                        
                        $actionHtml .= '<button data-href="'.action('App\Http\Controllers\ExpenseCategoryController@destroy', [$row->id]).'" class="btn btn-xs btn-danger delete_expense_category"><i class="glyphicon glyphicon-trash"></i></button>';
                    }
                    return $actionHtml;
