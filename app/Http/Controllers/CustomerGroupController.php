        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($customer_group)
                    ->addColumn(
                        'action',
                        '@can("customer.update")
                            <button data-href="{{action(\'App\Http\Controllers\CustomerGroupController@edit\', [$id])}}" class="btn btn-xs btn-primary edit_customer_group_button" title="Edit"><i class="glyphicon glyphicon-edit"></i></button>
                        &nbsp;
                        @endcan

                        @can("customer.delete")
                            <button data-href="{{action(\'App\Http\Controllers\CustomerGroupController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_customer_group_button" title="Delete"><i class="glyphicon glyphicon-trash"></i></button>
                        @endcan'
                    )
