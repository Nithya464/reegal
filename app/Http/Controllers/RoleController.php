                ...
                ->addColumn('action', function ($row) {
                    if (! $row->is_default || $row->name == 'Cashier#'.$row->business_id) {
                        ...
                        if (auth()->user()->can('roles.update')) {
                            $action .= '<a href="'.action([\App\Http\Controllers\RoleController::class, 'edit'], [$row->id]).'" class="btn btn-xs btn-primary" title="Edit"><i class="glyphicon glyphicon-edit"></i></a>';
                        }
                        if (auth()->user()->can('roles.delete')) {
                            $action .= '&nbsp
                                <button data-href="'.action([\App\Http\Controllers\RoleController::class, 'destroy'], [$row->id]).'" class="btn btn-xs btn-danger delete_role_button" title="Delete"><i class="glyphicon glyphicon-trash"></i></button>';
                        }
