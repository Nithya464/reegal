    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($stock_adjustments)
                ->addColumn('action', '<button type="button" data-href="{{action([\App\Http\Controllers\StockAdjustmentController::class, \'show\'], [$id]) }}" class="btn btn-primary btn-xs btn-modal" data-container=".view_modal" title="View"><i class="fa fa-eye" aria-hidden="true"></i></button>
                 &nbsp;
                    <button type="button" data-href="{{  action([\App\Http\Controllers\StockAdjustmentController::class, \'destroy\'], [$id]) }}" class="btn btn-danger btn-xs delete_stock_adjustment '.$hide.'" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button>')
                ->removeColumn('id')
                ->editColumn(
                    'final_total',
                    function ($row) {
