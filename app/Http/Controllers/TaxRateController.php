        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    'action',
                    '@can("tax_rate.update")
                    <button data-href="{{action(\'App\Http\Controllers\TaxRateController@edit\', [$id])}}" class="btn btn-xs btn-primary edit_tax_rate_button" title="Edit"><i class="glyphicon glyphicon-edit"></i></button>
                        &nbsp;
                    @endcan
                    @can("tax_rate.delete")
                        <button data-href="{{action(\'App\Http\Controllers\TaxRateController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_tax_rate_button" title="Delete"><i class="glyphicon glyphicon-trash"></i></button>
                    @endcan'
                )
