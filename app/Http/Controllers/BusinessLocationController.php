    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($locations)
                ->addColumn(
                    'action',
                    '<button type="button" data-href="{{action(\'App\Http\Controllers\BusinessLocationController@edit\', [$id])}}" class="btn btn-xs btn-primary btn-modal" data-container=".location_edit_modal"><i class="glyphicon glyphicon-edit" title="Edit"></i></button>
                    <a href="{{route(\'location.settings\', [$id])}}" class="btn btn-success btn-xs" title="Settings"><i class="fa fa-wrench"></i></a>

                    <button type="button" data-href="{{action(\'App\Http\Controllers\BusinessLocationController@activateDeactivateLocation\', [$id])}}" class="btn btn-xs activate-deactivate-location @if($is_active) btn-danger @else btn-success @endif" title="Change Status"><i class="fa fa-power-off"></i> </button>
                    '
                )
                ->removeColumn('id')
