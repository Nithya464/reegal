...
class ProductUtil extends Util
{
     ...
     * @return array
     */
    public function createOrUpdatePurchaseLines($transaction, $input_data, $currency_details = null, $enable_product_editing = null, $before_status = null)
    {
        ...
        foreach ($input_data as $data) {
            ...
            $purchase_line->quantity = $this->num_f($data['quantity']);
            $purchase_line->secondary_unit_quantity = $new_quantity;
            ...
            $purchase_line->purchase_price_total = ($this->num_uf($data['total_price']));
            $purchase_line->purchase_price = ($this->num_uf($data['price']));
            ...
            $purchase_line->product_unit_price_id = ! empty($data['sub_unit_id']) ? $data['sub_unit_id'] : null;
