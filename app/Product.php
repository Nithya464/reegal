...
class Product extends Model
{
    ...
    /**
     * Get the product Unit Price associated with the product.
     */
    public function product_unit_price()
    {
        return $this->hasMany(\App\ProductUnitPrice::class, 'product_id', 'id')->where('status','1');
    }
    ...
    {
        return $this->hasOne(\App\ProductStock::class, 'product_id', 'id')->orderBy('id','DESC');
    }

    public function product_default_unit()
    {
        return $this->hasOne(\App\ProductUnitPrice::class, 'product_id', 'id')->where('status','1')->where('is_default','1');
    }
